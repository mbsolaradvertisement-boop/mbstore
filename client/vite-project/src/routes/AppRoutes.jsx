...
const Banners=lazyPage(()=>import("../pages/Admin/Banners"));
...
export default function AppRoutes() {
  return <Suspense fallback={<PageLoader/>}><Routes>
    <Route path="/" element={<HomeEntry/>}/><Route path="/catalogue" element={<Catalogue/>}/><Route path="/companies" element={<Companies/>}/><Route path="/login" element={<GuestAuthPage mode="login"/>}/><Route path="/register" element={<GuestAuthPage mode="register"/>}/><Route path="/forgot-password" element={<PasswordResetPage mode="forgot"/>}/><Route path="/reset-password/:token" element={<PasswordResetPage mode="reset"/>}/>
